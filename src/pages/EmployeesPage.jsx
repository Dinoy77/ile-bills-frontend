...
export default function EmployeesPage() {
    ...
    async function handleResetPassword(employeeId, employeeName) {
        const newPassword = window.prompt(`Enter a new password for ${employeeName}:`)
        if (!newPassword) return
        try {
            await resetEmployeePassword(token, employeeId, newPassword)
